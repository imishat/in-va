    ...
    <div className={s.root}>
      <Container>
        <div className={cn("items-center justify-between", s.content)}>
          <div className="">
            <h2 className="mb-12 text-5xl font-bold lg:text-6xl">
              <motion.h2
            ...
            >
              ...
              <div className="grid grid-cols-2 grid-rows-2 gap-7">
                <PhotoProvider>
                  <PhotoView>
                    <img src={img3.src} className="w-full object-cover" />
                  </PhotoView>
                </PhotoProvider>
                <PhotoProvider>
                  <PhotoView>
                    <img src={img4.src} className="w-full object-cover" />
                  </PhotoView>
                </PhotoProvider>
                <PhotoProvider>
                  <PhotoView>
                    <img src={img2.src} className="w-full object-cover" />
                  </PhotoView>
                </PhotoProvider>
                <PhotoProvider>
                  <PhotoView>
                    <img src={img1.src} className="w-full object-cover" />
                  </PhotoView>
                </PhotoProvider>
              </div>
            ...
            <div className="mt-8 text-center lg:mt-20">
              <Link href="/gallery">
                <a className="text-lg font-bold">View More</a>
              </Link>
            </div>
          </div>
        </div>
